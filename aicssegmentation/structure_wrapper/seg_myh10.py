...
def MYH10_HiPSC_Pipeline(struct_img,rescale_ratio,output_type, output_path, fn, output_func=None):
    ##########################################################################
    # PARAMETERS:
    ...
    if output_type == 'default': 
        ...
        MYH10_output(out_img_list, out_name_list, output_type, output_path, fn)
