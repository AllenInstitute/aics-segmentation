...
from aicssegmentation.core.output_utils import save_segmentation, MYL7_Cardio_output, generate_segmentation_contour
...
def Workflow_cardio_myl7(struct_img,rescale_ratio, output_type, output_path, fn, output_func=None):
    ...
    if output_type == 'default': 
        ...
        MYL7_Cardio_output(out_img_list, out_name_list, output_type, output_path, fn)
