...
def Workflow_npm1_comb(struct_img,mitotic_stage,rescale_ratio,output_type, output_path, fn, output_func=None):
    ##########################################################################
    # PARAMETERS:
    ...
    global_median_2 = np.percentile(structure_img_smooth,30) # 70 for M6M7, 30 for rest
